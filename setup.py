...
package_name = 'py_trees_ros_viewer_websocket'
...
setup(
    ...
    # },
    name=package_name,
    version='0.0.1',  # also package.xml
    ...
    extras_require={},
    author='Raphael Parreira',
    maintainer='Raphael Parreira <raphaelbp12@gmail.com>',
    url='https://github.com/raphaelbp12/py-trees-ros-viewer-websocket',
    keywords=['ROS', 'ROS2', 'py_trees', 'pytrees', 'py_trees_ros', 'behaviour-trees', 'Visualisation'],
    zip_safe=True,
    classifiers=[
    ...
    entry_points={
        'console_scripts': [
            'py-trees-tree-viewer-websocket = py_trees_ros_viewer_websocket.viewer:main',
        ],
    },
)
